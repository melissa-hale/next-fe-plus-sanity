...
export default async function Home() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 min-h-screen flex justify-center flex-col">
      <div className="text-xl text-green-900 mb-60 p-12 bg-gray-200 bg-opacity-60 rounded-2xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
